...
data=pd.read_csv(r"C:\Users\DEll\OneDrive\Documents\data science\heart_disease_health_indicators_BRFSS2015 (1).csv")
data.head(10)
data.head()
data.tail()
data.isna().sum()
...
data=pd.read_csv(r"C:\Users\DEll\OneDrive\Documents\data science\heart_disease_health_indicators_BRFSS2015 (1).csv",na_values=[0])
data.isna().sum()
